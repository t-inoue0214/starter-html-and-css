...
Flexbox と Position が難易度がほかより高い点としては、親要素のタグと子要素のタグを考慮して、適切な位置にプロパティを指定する必要があります。

また、そのために `div`要素を増やす必要があるケースも存在しており、初学者は混乱することが多いです。
...
> **初心者がハマる「基準点」の罠**  
> `absolute` を使いたい時は、**必ずその親（枠）に `position: relative;` をつけてください。**  
...
次は最後の仕上げ [07. CSS の高度なテクニック（アニメーションと状態変化）](../07_css_advanced/README.md) へ進みます。
